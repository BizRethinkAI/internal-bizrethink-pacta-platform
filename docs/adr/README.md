...
| [0026](0026-an-entity-and-a-type-make-a-template.md) | An entity and a document type make a template | **Proposed** | Amends 0025 and 0016. A template stops being a package: entity + type = one template. Nothing built until accepted |
