...
export const FRPA_GUARANTY: McaClause[] = [
  ...
  },
  {
    ...
    section: 'guaranty',
    sortKey: 30,
    heading: 'Cross-Collateral',
    body: 'To secure Guarantor’s payment and performance obligations to Buyer under this Guaranty, Guarantor hereby grants Buyer a security interest in any additional collateral identified in any schedule executed by Guarantor in connection with this Agreement (the “Additional Collateral”). The Additional Collateral secures only the Guaranteed Obligations as defined in Section 9.2, and secures no other obligation of Merchant or Guarantor under this Agreement.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
