...
export const EQUIPMENT_LEASE_AGREEMENT: McaClause[] = [
  {
    ...
    sortKey: 1,
    heading: 'Parties',
    body: 'This Equipment Lease Agreement (this “Agreement”) is made between {{field:equipment.providerLegalName}}, a {{field:equipment.providerEntityType}} formed in {{field:equipment.providerFormationState}}, with its principal office at {{field:equipment.providerAddress}} (“we,” “us,” or “our”), and the Lessee identified in the Lessee and Equipment Information grid (“you” or “your”). The completed grid identifies this Agreement, the parties, the Equipment, the payment schedule and the effective date. We are the equipment counterparty; naming a receivables funder, processor or service provider does not make it a party or establish an affiliation. This Agreement becomes effective only as Section [[clause:equipment-lease.effective-date-term-and-interim-rent]] provides.',
