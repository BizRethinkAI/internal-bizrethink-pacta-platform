...
/**
 * The Subscription Agreement — section 3.
 *
...
export const SUBSCRIPTION_AGREEMENT: McaClause[] = [
  {
    ...
    sortKey: 1,
    heading: 'Parties',
    body: 'This Subscription Agreement (this “Agreement”) is entered into and effective as of ____«20»_____ between ________«37»________, a Florida limited liability company, with its principal office at _______________«41»_______________ (“we,” “us,” or “our”), and the Subscriber identified in the Subscriber and Equipment Information grid above (“Subscriber,” “you,” or “your”).',
  ...
  },
  {
    ...
    body: 'Total payments are estimated to be the number of months in the Subscription Term stated above multiplied by the monthly subscription charge stated above. See Sections [[clause:subscription.effective-date-term-and-interim-rent]](b) and [[clause:subscription.payment-of-amounts-due]] for further details. Subscriber will pay all applicable taxes as set out in Section [[clause:subscription.payment-of-amounts-due]](c); such taxes may be collected prior to payment to the taxing authority.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [{ review: 'REVIEW-01', findings: [] }],
  ...
  },
  {
    ...
    body: '(a) This Agreement becomes effective on the earlier of the date we deliver any piece of Equipment to you (the “Delivery Date”) or acceptance by us. This Agreement remains in effect until all of your obligations and all of our obligations under it have been satisfied. We will deliver the Equipment to the site designated by you. (b) The term of this Agreement begins on a date designated by us after receipt of all required documentation and acceptance by us (the “Commencement Date”), and continues for the number of months stated as the Subscription Term in the Subscriber and Equipment Information grid. You agree this Agreement is a non-cancelable commitment by you to subscribe for the Equipment identified for the entire Subscription Term. You agree to pay all amounts due during the Subscription Term and confirm by executing this Agreement that the Subscription Term is specifically defined as written in the Subscriber and Equipment Information grid. (c) You agree to pay an Interim Subscription Payment in the amount of one-thirtieth (1/30th) of the monthly subscription charge for each day from and including the Delivery Date until the date preceding the Commencement Date. The Interim Subscription Payment shall never exceed one monthly subscription charge in total, and if we have not designated a Commencement Date within thirty (30) days after the Delivery Date the Commencement Date is the thirtieth day after the Delivery Date. (d) You acknowledge that the Equipment and software you subscribe for under this Agreement may not be compatible with another processor’s systems and that we do not have any obligation to make such software or equipment compatible if you elect to use another service provider. Upon termination of your merchant processing agreement, you acknowledge that you may not be able to use the Equipment or software subscribed for under this Agreement with any other service provider.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  },
  {
    ...
    body: '(a) Schedule of Fees. This is every charge payable under this Agreement. Monthly subscription charge: as stated in the Subscriber and Equipment Information grid. Interim Subscription Payment: as calculated under Section [[clause:subscription.effective-date-term-and-interim-rent]](c), capped at one monthly subscription charge. Delivery and installation: as assessed, stated to you before delivery. Taxes and assessments: as levied, under Section [[clause:subscription.payment-of-amounts-due]](c). Late Fee: ten percent (10%) of the past-due instalment, minimum $5.00, for each month it remains unpaid, prorated for a partial month, and never more than the law allows — the same charge stated in Section [[clause:subscription.payment-of-amounts-due]](e). Collection expense fee: $25 per aggregate payment requiring a collection effort, under Section [[clause:subscription.payment-of-amounts-due]](f). Upgrade Fee: $50. Assumption Fee: $250. Collection costs: actual costs of collection plus reasonable attorneys’ fees, capped at 25% of the amount in collection. Fair market value of Equipment not returned when required, under Sections [[clause:subscription.return-or-continuation-of-equipment-at-end-of-subscription-term]] and [[clause:subscription.default-remedies]](b). No other periodic or transactional charge is payable, and we will not introduce one during the Subscription Term. Amounts recoverable under Sections [[clause:subscription.use-return-of-equipment-and-insurance]](g), [[clause:subscription.indemnification]] and [[clause:subscription.default-remedies]](b) are not charges under this Schedule and are recoverable only as those Sections provide. (b) The first monthly subscription charge is due on the Commencement Date, and each subsequent charge is due on the same day of each successive month of the Subscription Term for each piece of Equipment. We will invoice you at least ten (10) days before each due date at the email address you give us, and you will remit by the due date by any method we make available. We will not debit your bank account for these charges unless you separately authorise it in writing, and you may withdraw that authorisation at any time. You agree to pay all assessed costs for delivery and installation of Equipment. (c) In addition to the monthly subscription charge, you shall pay, or reimburse us for, amounts equal to any taxes or assessments on or arising out of this Agreement or the Equipment, and related supplies or any services, use, or activities hereunder, including without limitation state and local sales, use, property, privilege, and excise tax, exclusive of taxes based on our net income. Reimbursement of property tax calculation is based on an average tax rate. (d) Your subscription payments will be due despite dissatisfaction for any reason with the Equipment or related processing services. (e) Whenever any payment is not made by you in full when due, you shall pay us as a late charge an amount equal to ten percent (10%) of the amount due but no less than $5.00 for each month during which it remains unpaid (prorated for any partial month), but in no event more than the maximum amount permitted by law. (f) In the event your account is placed into collections for past-due subscription amounts, you agree that we can recover a collection expense fee of $25 for each aggregate payment requiring a collection effort, but in no event more than the maximum amount permitted by law.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  },
  {
    ...
    body: 'We at all times retain title to the Equipment unless we agree otherwise in writing. You agree to execute and deliver to us any statement or instrument that we may request to confirm or evidence our ownership of the Equipment, and you irrevocably appoint us as your attorney-in-fact to execute and file the same in your name and on your behalf. The transaction contemplated by this Agreement shall be treated as a lease; however, if a court determines that the transaction is not governed by Article 2A of the Uniform Commercial Code (or a similar provision adopted in the relevant jurisdiction), then we shall be deemed to have a first-lien security interest on the Equipment as of the date of this Agreement, and you will execute such documentation as we may request to evidence such security interest.\nEquipment Charged Only Once. This Subscription covers equipment for which no cost has been deferred into, or deducted at funding under, any future receivables purchase agreement between you and any of our affiliates. If the cost of the same equipment has been charged that way, the Monthly Subscription Amount for that equipment is $0.00 and this Subscription is not executed for it. You will never pay for the same equipment twice.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  },
  {
    ...
    body: 'Upon the completion of your Subscription Term or any extension thereof, you will have the option to (a) return the Equipment to us; or (b) after the final subscription payment has been received by us, the Agreement will continue month-to-month at the existing monthly subscription payment. If you do not want to continue the subscription, you must give us written notice at least thirty (30) days before the end of the Subscription Term, or at least thirty (30) days before the end of any subsequent monthly period, and return the Equipment. Notice given later takes effect at the end of the following monthly period. If we terminate the subscription pursuant to Section [[clause:subscription.default-remedies]](b) due to a default by you, you shall immediately return the Equipment no later than the tenth business day after termination, or remit to us the fair market value of the Equipment as determined in good faith by us. You agree to pay any amounts due to us under this Section promptly upon our request.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  */
  {
    ...
    body: 'Section [[clause:subscription.guaranty-of-payment]] states the whole of what a guarantor guarantees under this Agreement, and this Section adds nothing to it. A guarantor is not liable under this Section for an obligation that Section [[clause:subscription.guaranty-of-payment]] says the guarantor does not owe.\nNo guarantor has a right of subrogation to our rights against you, or to our interest in the Equipment, until the obligations guaranteed by Section [[clause:subscription.guaranty-of-payment]] have been satisfied. A guarantor who has paid us the fair market value of Equipment under Section [[clause:subscription.guaranty-of-payment]](a) is subrogated on that payment to our interest in that Equipment, and we will do what the guarantor reasonably asks to evidence it.\nIndebtedness owed by you to a guarantor is subordinated to the obligations guaranteed by Section [[clause:subscription.guaranty-of-payment]], and no payment may be made or accepted on that indebtedness while any of those obligations is due and unpaid. When those obligations are satisfied this subordination ends, whether or not another amount remains payable to us under this Agreement.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
