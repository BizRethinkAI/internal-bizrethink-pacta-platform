...
const renderRow = (options: RenderRowOptions) => {
  ...
  const metaParts = [auditLog.email || 'N/A', auditLog.ipAddress || 'N/A', os, browser].filter(
    Boolean,
  );
