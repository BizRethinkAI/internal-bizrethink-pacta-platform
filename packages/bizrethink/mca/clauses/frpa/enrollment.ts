  ...
  */
  {
    ...
    body: 'This Agreement shall continue until the Completion Threshold is attained (Section [[clause:frpa.completion-threshold-2-6]]).',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  */
  {
    ...
    body: 'Subject to Section [[clause:frpa.financial-condition-4-3]], Section [[clause:frpa.protection-of-information-4-7]] and Section [[clause:frpa.electronic-account-monitoring-authorization-plaid-4-16]], Merchant authorizes each Approved Processor and each Bank to give Buyer Merchant’s card processing and account history: before the Purchase Date, the history reasonably necessary to underwrite this transaction; and after the Purchase Date, the history reasonably necessary to verify Purchased Receipts, to reconcile under Section [[section:reconciliation]], and to service this Agreement lawfully.\nA decline in Merchant’s sales, receipts or creditworthiness after the Purchase Date does not permit Buyer to revoke the purchase, require repayment, or suspend a reconciliation under Section [[section:reconciliation]], and does not change the Specified Percentage. Section [[clause:frpa.events-of-default-6-1]] states the only conduct that is an Event of Default.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
  ...
  */
  {
    ...
    body: 'Merchant appoints Buyer its agent for the limited and ministerial purposes stated in this Section and for no other purpose. To the extent applicable law permits, and only so far as is reasonably necessary for Buyer to receive the Purchased Receipts, Buyer may (i) deliver to an Approved Processor the Split Funding Authorization Merchant has executed under Section [[clause:frpa.primary-collection-split-funding-via-approved-processor-2-3]], together with an accurate correction or termination of it, and (ii) endorse an instrument made payable to Buyer and Merchant jointly, solely to the extent of the Specified Percentage of the Card Receipts the instrument represents, and remit the remainder to Merchant promptly.\nNotice is a condition of this authority. Buyer shall send Merchant a copy of each instruction it delivers to an Approved Processor at the same time it delivers it, and shall notify Merchant of an endorsement promptly, with the amount endorsed and the amount remitted. An act taken without that notice is not authorized by this Section.\nThis authority does not permit Buyer to sign, in Merchant’s name, a pleading, an affidavit, an admission, a confession of judgment, a settlement agreement, an insurance application or claim, an invoice, a bill of lading, an assignment directing a customer or account debtor to pay Buyer, or a financing or security document; to obtain or adjust insurance; to institute or defend a proceeding; or to collect Merchant’s retained share of Card Receipts, a non-card receipt, an account receivable, or any other asset of Merchant.\nThis authority is not a remedy. It confers nothing on an Event of Default, it is not coupled with an interest beyond the Purchased Receipts, and Section [[clause:frpa.remedies-6-2]] governs what Buyer may do on an Event of Default and states that Buyer holds no power of attorney for that purpose. Merchant may revoke this authority at any time, except so far as revocation would defeat a Split Funding Authorization then in force. It circumvents no notice, no judicial process, no automatic stay and no limit in Section [[section:default]], and it ends when this Agreement reaches the Completion Threshold under Section [[clause:frpa.completion-threshold-2-6]].',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
  ...
  */
  {
    ...
    sortKey: 120,
    heading: 'Remedies',
    body: 'Buyer may enforce only the rights and remedies Section [[clause:frpa.remedies-6-2]] expressly gives it, and only subject to the notice and cure requirement in Section [[clause:frpa.events-of-default-6-1]], the aggregate limit in Section [[clause:frpa.costs-of-collection-6-3]], the separately signed Guaranty of Performance for any claim against a Guarantor, and applicable law. Nothing in this Section, and nothing elsewhere in this Agreement, enlarges the Purchased Receipts, accelerates Card Receipts that have not been generated, permits collection of Merchant’s retained share of Card Receipts, or makes Buyer’s remedies cumulative of any remedy Section [[clause:frpa.remedies-6-2]] does not give.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
  ...
  */
  {
    ...
    instrument: 'frpa',
    kind: 'clause',
    referenceId: 'frpa.single-active-position-4-15',
    /*
  ...
  */
  {
    ...
    body: 'Merchant may authorize read-only electronic access to an Approved Bank Account identified for the purpose, through Plaid, Inc. or another bank-data aggregation service Buyer identifies to Merchant before the connection is made. Before the connection is made, Buyer shall tell Merchant the categories of data Buyer will receive, the service provider, how long the access will run, and how Merchant may revoke it. The access is limited to the purposes Section [[clause:frpa.financial-condition-4-3]] and Section [[clause:frpa.transaction-history-4-4]] permit: verifying Card Receipts, supporting a reconciliation under Section [[section:reconciliation]], and confirming that the Specified Percentage is being remitted by an Approved Processor.\nThis authorization never permits a debit, transfer or withdrawal. Collection is governed by Section [[clause:frpa.primary-collection-split-funding-via-approved-processor-2-3]].\nMerchant may instead give Buyer the equivalent processor reports or account statements, and shall do so if the connection is not made, lapses or is revoked. Buyer shall provide a reasonable alternative and reasonable assistance. A lapse, a token expiry, a bank-side restriction, an outage at the service, or a good-faith revocation by Merchant is not an Event of Default and gives Buyer no remedy; Section [[clause:frpa.events-of-default-6-1]] states that a loss of access to information or to a system is not one. Withholding or revoking data access is not the conduct described in Section [[clause:frpa.events-of-default-6-1]](b), and Buyer may treat it as evidence of that conduct only together with other evidence of it.\nBuyer shall end active access when this Agreement reaches the Completion Threshold under Section [[clause:frpa.completion-threshold-2-6]] or is otherwise terminated, shall retain only the records reasonably needed for legal compliance or for a specific identified dispute, and shall apply Section [[clause:frpa.protection-of-information-4-7]] to everything obtained under this Section. No bank credentials and no raw transaction data may be furnished to a reporting organization under Section [[clause:frpa.reporting-7-15]].',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
