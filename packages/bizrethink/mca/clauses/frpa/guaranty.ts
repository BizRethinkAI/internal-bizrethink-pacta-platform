  ...
  */
  {
    ...
    body: 'Subject to Section [[clause:frpa.guaranty-of-performance-9-2]], Buyer need not first obtain judgment against Merchant, or realize upon the Collateral described in Section [[clause:frpa.security-interest-4-10]], before bringing a valid claim against a Guarantor. No renewal, additional purchase, material amendment, substituted obligation or increase in the Purchased Amount binds a Guarantor without that Guarantor’s separate written consent identifying the resulting obligation.\nA notice of termination or non-renewal given by a Guarantor does not itself create a default or any liability. It prevents this Guaranty from extending to any later transaction, and does not release the Guarantor from liability for conduct in this transaction that Section [[clause:frpa.guaranty-of-performance-9-2]] independently covers. No future transaction is covered without a fresh signed consent.\nEach Guarantor retains its defences as to validity, scope, causation, amount and payment, and all rights that may not be waived. Subrogation, reimbursement and contribution are postponed only while their exercise would cause a duplicate recovery or would materially impair recovery of a valid unpaid Guaranteed Obligation; they are not waived. A payment returned or avoided in a bankruptcy proceeding does not enlarge or reinstate this Guaranty. Consistently with Section [[clause:frpa.events-of-default-6-1]], a bankruptcy filing, an insolvency and an avoidance create no liability for a Guarantor without independently proven conduct covered by Section [[clause:frpa.guaranty-of-performance-9-2]]. Enforcement remains subject to any applicable stay and to applicable law.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  */
  {
    ...
    body: 'Each Guarantor’s liability is determined separately under Section [[clause:frpa.guaranty-of-performance-9-2]]. Two or more Guarantors are jointly and severally liable only for the same proven loss caused by conduct that Section [[clause:frpa.guaranty-of-performance-9-2]] independently covers for each of them, and Buyer may recover that loss only once. No person is liable merely because another Guarantor signed this Agreement or committed a wrongful act.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
  ...
  */
  {
    ...
    body: 'Each Guarantor acknowledges receiving the whole of Section [[section:guaranty]] and the complete Agreement, understanding that Section [[clause:frpa.guaranty-of-performance-9-2]] creates limited personal or entity liability for specified conduct, and having a reasonable opportunity to ask questions and to consult independent counsel. A Guarantor may choose not to consult counsel. This acknowledgement does not expand liability and does not waive a defence or a statutory right.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  */
  {
    ...
    instrument: 'frpa',
    kind: 'clause',
    referenceId: 'frpa.guarantor-acknowledgement-9-6',
    /* Pairs with the record above. See the note on the full-performance set. */
    includeWhen: (facts) => facts.guarantyScope === 'full-performance',
    section: 'guaranty',
    sortKey: 60,
    heading: 'Guarantor Acknowledgement',
    body: 'Each Guarantor acknowledges receiving the whole of Section [[section:guaranty]] and the complete Agreement, understanding that Section [[clause:frpa.guaranty-of-performance-9-2]] creates personal or entity liability for Merchant’s performance of every representation, warranty and covenant in this Agreement, and having a reasonable opportunity to ask questions and to consult independent counsel. A Guarantor may choose not to consult counsel. This acknowledgement does not expand liability and does not waive a defence or a statutory right.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  */
  {
    ...
    section: 'service',
    sortKey: 10,
    heading: 'Service of Judicial Process',
  ...
  */
  {
    ...
    */
    ...
    section: 'service',
    sortKey: 20,
    heading: 'Service on a Guarantor',
    body: 'Service of process on a Guarantor is governed by Section [[clause:frpa.section-10-1]], which applies to each party to this Agreement, including each Guarantor. This Section states no separate waiver and imposes no obligation on a Guarantor that Section [[clause:frpa.section-10-1]] does not impose on every party.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
  ...
  */
  {
    ...
    section: 'service',
    sortKey: 50,
    heading: 'Changes of Address',
    body: 'Merchant, Buyer and each Guarantor shall keep current the addresses each gives in this Agreement, and shall give a change of address under Section [[clause:frpa.notices-7-3]].\nA failure to keep an address current does not by itself establish valid service of judicial process, does not give up a procedural protection, and does not make a communication sent to a former address into service. Section [[clause:frpa.section-10-1]] governs judicial process.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [{ review: 'REVIEW-02', findings: [] }],
  ...
  */
  {
    ...
    section: 'service',
    sortKey: 60,
    heading: 'Operational Notices and Judicial Process',
    body: 'Section [[clause:frpa.section-10-1]] governs the service of a summons, a complaint and other judicial process, and it is the only provision of this Agreement that does. Section [[clause:frpa.notices-7-3]] governs a notice, a request, a consent and any other communication between the parties about the administration of this Agreement.\nNeither Section displaces a mandatory rule of procedural law or an order of a court, and neither of them overrides the other.\nWhere it is unclear which of the two applies to a communication, the subject decides: a step in a proceeding is judicial process, and anything else is a notice.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [{ review: 'REVIEW-02', findings: [] }],
