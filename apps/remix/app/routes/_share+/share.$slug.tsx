...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'Pacta - Share' },
    { description: 'I just signed a document in style with Pacta!' },
    {
      property: 'og:title',
      content: 'Pacta - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with Pacta!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for Pacta.
