...
--
-- NO LONGER TRUE AS OF 2026-09-06. The property and matter were personal and
-- were moved to org_nkzrmhochvhmbwnt (/o/personal), and this grant was
-- transferred with them by
-- scripts/one-off/2026-09-06-move-picana-to-personal.sql. The company
-- organisation now holds no lease work and no grant. Left here unedited
-- because an applied migration is a record of what ran, not a description of
-- the present; see docs/STATE.md for where things actually stand.
--
