...
export const UT_DISCLOSURE: ContentStatute = {
  ...
  // Re-read §202 on 2026-09-12 to correct the §201 registration citations.
  // The digest changes only for the header recording the audit's official
  // retrieval. The full statutory body still matches the independent audit;
  // ut-ca-statutory-references.test.ts checks that separately from this digest.
  sourceDigest: 'd686e6d016fb4828ceccb9cbde18e02af393aa528f5be8ea4de5cd10774aaf21',
  section: null,
  requirements: [
    {
      citation: 'Utah Code §7-27-202(2)(a)',
      requires: 'The total amount of funds provided to the business.',
      row: 'Total Funds Provided',
      evidence: ['gross amount'],
    },
    {
      citation: 'Utah Code §7-27-202(2)(b)',
      requires: 'The total amount of funds disbursed, if less than (a).',
      row: 'Total Funds Disbursed',
      evidence: ['after deductions'],
    },
    {
      citation: 'Utah Code §7-27-202(2)(c)',
      requires: 'The total amount to be paid to the provider.',
      row: 'Total Amount to Repay',
      evidence: ['remit to Provider'],
    },
    {
      citation: 'Utah Code §7-27-202(2)(d)',
    ...
    {
      citation: 'Utah Code §7-27-202(2)(e)(ii)',
      requires:
        'Where payments may vary: the manner, frequency and estimated amount of the initial payment. The methodology and the circumstances that may cause a payment to vary belong in the AGREEMENT under §7-27-202(3), not in this disclosure.',
      row: 'Estimated Periodic Payment',
      evidence: ['Each Workday', 'Specified Percentage'],
    },
    {
      citation: 'Utah Code §7-27-202(2)(f)',
      requires:
