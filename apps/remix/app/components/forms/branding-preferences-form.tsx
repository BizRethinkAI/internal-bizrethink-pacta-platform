...
export function BrandingPreferencesForm({
  ...
  const savedValues: TBrandingPreferencesFormSchema = {
    ...
    // MODIFIED for BizRethink (overlay 025): per-org "Powered by Pacta" toggle.
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start gap-x-3 space-y-0 rounded-md border border-border p-4">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    <FormDescription>
                      <Trans>
                        When enabled, outgoing emails from this organisation won't display the "This document was sent
                        using Pacta" footer line. Useful when this organisation has its own brand identity it wants to
