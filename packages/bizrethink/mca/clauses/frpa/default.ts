  ...
  */
  {
    ...
    instrument: 'frpa',
    kind: 'clause',
    referenceId: 'frpa.events-of-default-6-1',
    /* The complement of the record above. Between them the section is always present. */
    includeWhen: (facts) => facts.guarantyScope === 'full-performance',
    section: 'default',
    sortKey: 10,
    heading: 'Events of Default',
    body: 'An Event of Default occurs only if Merchant (a) commits fraud in procuring or performing this Agreement; (b) intentionally diverts, conceals or transfers Purchased Receipts that have actually arisen, for the purpose of preventing their delivery to Buyer; or (c) knowingly sells or grants another person a conflicting interest in the same Purchased Receipts, for the purpose of defeating Buyer’s ownership. Nothing else is an Event of Default.\nNotice and Opportunity to Cure. Buyer shall give Merchant written notice identifying the conduct and the facts Buyer relies on. Where the conduct is capable of cure, no Event of Default occurs unless it remains uncured ten (10) Workdays after Merchant receives that notice, and Buyer shall exercise no remedy under Section [[clause:frpa.remedies-6-2]] before that period has run. Buyer may apply to a court for temporary relief in accordance with applicable law.\nWhat is not an Event of Default. None of the following is itself an Event of Default, and none of them gives Buyer any remedy under this Section [[section:default]]: a decline in or an absence of Card Receipts; a delay in payment by Merchant’s customers; an ordinary loss of the business; a good-faith closure, suspension, relocation, dissolution or sale of the business; Merchant’s insolvency, or a bankruptcy filing by or against Merchant; the failure, outage or withdrawal of service of a Bank or an Approved Processor; a loss of access to information or to a system; a collection below the Estimated Daily Holdback; a reconciliation request under Section [[section:reconciliation]], an adjustment to the Estimated Daily Holdback under Section [[clause:frpa.adjustment-of-the-estimated-daily-holdback-3-4]], or a good-faith dispute; a failure or delay in giving Buyer records or information requested under this Agreement; a notice of termination or non-renewal given by a Guarantor; the addition or replacement of an Approved Bank Account or an Approved Processor under Section [[clause:frpa.approved-bank-account-2-4]]; additional financing taken by Merchant; a fall in the value of any Collateral; and a default by Merchant under any other agreement, including another agreement with Buyer.\nBankruptcy and Business Failure. Notwithstanding anything in this Agreement to the contrary, neither the filing of a voluntary or involuntary petition under Title 11 of the United States Code, nor Merchant’s insolvency, nor the cessation of Merchant’s business for lack of revenue, shall constitute an Event of Default or give rise to any remedy under this Section [[section:default]] or to any liability of any Guarantor.\nCovenants that are not Events of Default. Merchant’s covenants in this Agreement, including those in Sections [[section:enrollment]] and [[section:representations]], remain covenants, and a breach of one is an Event of Default only where it is conduct described in (a), (b) or (c) above. A breach that is not an Event of Default may support proportionate lawful relief for proven direct loss under Section [[clause:frpa.remedies-6-2]]; it does not make the uncollected Purchased Amount payable and does not suspend Merchant’s rights under Section [[section:reconciliation]]. Where Section [[clause:frpa.guaranty-of-performance-9-2]] guarantees the covenant breached, a claim against a Guarantor is limited to that same proportionate lawful relief for that same proven direct loss, on the same proof, and is brought only as Section [[clause:frpa.guaranty-of-performance-9-2]] permits; no breach of this Agreement, and no Event of Default, makes the uncollected Purchased Amount payable by a Guarantor. Incomplete information is not evidence of the conduct described in (a), (b) or (c). Buyer bears the risk that Purchased Receipts may never arise. This Section controls any inconsistent term of this Agreement and of any document incorporated into it, subject to mandatory law.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  */
  {
    ...
    body: 'Merchant shall notify Buyer under Section [[clause:frpa.notices-7-3]] promptly after Merchant learns of a filing under Title 11 of the United States Code by or against Merchant, and ordinarily within three (3) Workdays where that is practicable, so that Buyer can comply with the automatic stay and with any other applicable law. Merchant shall give Buyer reasonable advance notice of a planned sale of the kind described in Section [[clause:frpa.change-of-name-or-location-or-sale-or-closing-of-business-5-18]], ordinarily seven (7) calendar days where that is practicable. Notwithstanding Section [[clause:frpa.notices-7-3]], a notice under this Section may be sent by email to the address stated in the Merchant and Funding Information grid and is effective when sent.\nA failure or delay in giving a notice under this Section is not an Event of Default, does not accelerate any amount, does not entitle Buyer to any charge, and does not create liability for any Guarantor. Buyer shall comply independently with any stay, court order or other legal restriction of which it has notice, whether or not Merchant gives notice under this Section.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  // Split from the former costs-of-collection body without changing its words.
