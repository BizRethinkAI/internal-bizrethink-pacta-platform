  ...
  */
  {
    ...
    body: 'The parties agree to the non-recourse allocation stated in the granting clause and in Section [[clause:frpa.sales-of-receipts-not-a-loan-2-1]]. Buyer assumes the risk that Merchant generates insufficient Purchased Receipts, and the risk that collection takes an indefinite time. Merchant does not warrant, and is not asked to certify, how a court or a regulator will characterize this transaction. Nothing in this Section waives a statutory protection or defence available to either party.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  */
  {
    ...
    sortKey: 60,
    heading: 'The Account',
    body: 'A change to an Approved Bank Account or an Approved Processor that affects the collection of Purchased Receipts is governed exclusively by Section [[clause:frpa.approved-bank-account-2-4]]. Merchant shall cooperate reasonably in keeping the agreed split in place. Intentional diversion of Purchased Receipts is governed by Section [[clause:frpa.no-diversion-of-receipts-5-17]] and by no other provision of this Section. No account change, no processor change, and no adverse effect on Buyer’s collection is by itself an Event of Default.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  */
  {
    ...
    */
    ...
    body: 'A further sale of the Purchased Receipts, and a voluntary encumbrance of them, are restricted by Section [[clause:frpa.negative-pledge-4-11]] and by no other provision of this Agreement. A charge for equipment leased or subscribed from an equipment provider, and a payment under a subscription, obtains no security interest and no priority under this Agreement, and does not rank against the Purchased Receipts.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [{ review: 'REVIEW-02', findings: [] }],
  ...
  */
  {
    ...
    body: 'Merchant enters this Agreement primarily for a lawful business or commercial purpose, and the use of proceeds Merchant has stated to Buyer in writing before the Purchase Date is accurate. If Merchant is an entity, the Merchant and Funding Information grid states its legal form and the jurisdiction in which it is organized. If Merchant is a sole proprietor, the Merchant and Funding Information grid identifies that status and the legal owner of the business. the Merchant and Funding Information grid states Merchant’s principal place of business, and where the business is principally directed or managed from a different address, Merchant has stated that address to Buyer in writing before the Purchase Date. Buyer shall verify the facts needed to determine which law applies to this transaction. This Section does not convert a transaction that is primarily for personal, family, or household purposes into a business transaction, and does not waive a protection that applies to one.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  */
  {
    ...
    body: 'Merchant has disclosed to Buyer each known contractual restriction that would materially prevent the sale of the Purchased Receipts or the processor split under Section [[clause:frpa.primary-collection-split-funding-via-approved-processor-2-3]]. Merchant does not make a legal warranty that this transaction cannot be avoided, subordinated or challenged under bankruptcy, fraudulent-transfer, preference or other law, and Merchant retains every defence available to it under those laws. No such challenge, and no such avoidance, itself creates an Event of Default or liability under the Guaranty.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  */
  {
    ...
    body: 'Merchant has disclosed to Buyer each proceeding pending, and each proceeding to its actual knowledge threatened, that materially affects its authority to enter this Agreement or its ability lawfully to sell the Purchased Receipts, in each case as at the Purchase Date. This is not a warranty against future litigation, against an adverse outcome, or against a decline in Merchant’s business. A remedy for an inaccuracy in this Section is subject to Section [[section:default]] and the separately signed Personal Guaranty of Performance.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
  ...
  */
  {
    ...
    body: 'Merchant’s undertaking not to sell the same Purchased Receipts to another person, and not to grant a voluntary interest that conflicts with Buyer’s interest in them, is stated in Section [[clause:frpa.negative-pledge-4-11]]. This Section does not enlarge it.\nFinancing that Merchant obtains on other assets, or on Merchant’s retained share of Card Receipts, is not prohibited by this Agreement, and taking it is not an Event of Default; Section [[clause:frpa.events-of-default-6-1]] states the only conduct that is. Before entering an arrangement that would affect the share of Card Receipts sold to Buyer, Merchant shall give Buyer the information reasonably necessary to assess the conflict, and Buyer shall respond reasonably and promptly.\nBuyer may use and disclose information given under this Section only as Section [[clause:frpa.protection-of-information-4-7]] permits, and may not disclose it to any other person in order to police this Section.\nBuyer’s own subsequent purchases from Merchant are governed by Section [[clause:frpa.single-active-position-4-15]].',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
  ...
  */
  {
    ...
    body: 'Merchant shall keep in place the instructions under Section [[clause:frpa.primary-collection-split-funding-via-approved-processor-2-3]] by which each Approved Processor remits the Purchased Receipts in its ordinary settlement cycle, and shall account for any Purchased Receipts it receives itself and remit them under Section [[clause:frpa.return-of-buyer-proceeds-7-16]]. Merchant shall not intentionally conceal or divert the Purchased Receipts in order to defeat Buyer’s ownership of them.\nNone of the following is concealment or diversion: an ordinary settlement delay; a refund, a chargeback or a processor reserve; a bank holiday, a bank failure or a processor outage; a change of account or processor made and disclosed under Section [[clause:frpa.approved-bank-account-2-4]]; or a good-faith commercial decision about how Merchant operates, prices or promotes its business.\nThis Agreement imposes no daily deposit obligation. Merchant’s non-card receipts, and Merchant’s retained percentage of Card Receipts, are Merchant’s to bank and to use as it chooses.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [
