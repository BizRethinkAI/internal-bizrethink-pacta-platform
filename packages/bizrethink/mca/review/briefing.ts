  ...
  return [
    ...
    },
    {
      ...
      body: [
        ...
        `**Clause numbers are the document's own, never invented.** Forty clauses across the library carry no number in the contract — granting clauses, recitals, the sentence that makes the instrument a sale rather than a loan — and those are shown without one. Each clause also carries a short reference in the margin. It is our internal handle, not part of the contract, and it is the most precise way to cite a clause back to us.`,
