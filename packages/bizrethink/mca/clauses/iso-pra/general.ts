...
export const ISO_PRA_GENERAL: McaClause[] = [
  ...
  },
  {
    ...
    body: 'This Agreement, including Section [[section:commission]] and its appendices, constitutes the entire agreement between the parties and supersedes all prior negotiations, representations, and agreements. This Agreement may only be amended in writing signed by both parties.',
    source: { kind: 'attorney-drafted', author: null },
    status: 'draft',
    appliesInStates: [],
    examinedBy: [{ review: 'REVIEW-01', findings: [] }],
