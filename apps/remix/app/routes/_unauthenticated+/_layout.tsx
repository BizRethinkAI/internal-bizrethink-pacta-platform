...
export default function Layout() {
  return (
    <main className="relative flex min-h-screen flex-col">
      ...
      {/* Page content centered in the remaining viewport space. */}
      <div className="relative flex flex-1 flex-col items-center justify-center overflow-hidden px-4 py-8 md:p-12 lg:p-16">
